load_connectivity_data_noresid_between_network_conn <- function(){
  ...
  conndat_bnc <- data.frame(screen_id=sapply(uid, function(u){paste(strsplit(as.character(u), '')[[1]][1:5], collapse = '')}), tmp)
  
  save(conndat_bnc, file = '/ifshome/bwade/NARSAD/Aim_1/data/conn_bnc.Rdata')
