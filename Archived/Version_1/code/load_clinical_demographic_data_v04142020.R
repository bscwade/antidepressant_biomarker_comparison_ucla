...
load_clinical_demographic_data <- function(outcome){
  ...
  ## read data from April Export (Elizabeth)
  ...
  kdem <- kdat[kdat$redcap_event_name=='register_arm_2', c('screen_id', 'cont_age', 'cont_sex')]
  kdem_dep_features <- kdat[kdat$redcap_event_name=='consult_arm_2', c('screen_id', 'dabst_duration', 'dabst_num_episodes')]
  kdem <- merge(kdem, kdem_dep_features, by = 'screen_id')
  
  assertthat::are_equal(sum(duplicated(kdem)), 0)
  
  if(outcome=='hdrs6'){
    tmp <- kdat[kdat$redcap_event_name == 'baseline_arm_2' | kdat$redcap_event_name == 'postinfusion_asses_arm_2', c('screen_id', 'redcap_event_name', 'hamd_depressed_mood', 'hamd_guilt', 'hamd_activities', 'hamd_retardation', 'hamd_anxiety_psychic', 'hamd_somsxs_general')]
    ...
    kclin <- kdat[kdat$redcap_event_name == 'baseline_arm_2' | kdat$redcap_event_name == 'postinfusion_asses_arm_2', c('screen_id', 'redcap_event_name', grep(outcome, names(kdat), value = T))]
  }
  ...
  edem <- edat[edat$redcap_event_name=='register_arm_2', c('screen_id', 'cont_age', 'cont_sex')]
  edem_dep_features <- edat[edat$redcap_event_name=='baseline_arm_2', c('screen_id', 'dabst_duration', 'dabst_num_episodes')]
  edem <- merge(edem, edem_dep_features, by = 'screen_id')
  
  assertthat::are_equal(sum(duplicated(edem)), 0)
  
  if(outcome=='hdrs6'){
    tmp <- edat[edat$redcap_event_name == 'baseline_arm_2' | edat$redcap_event_name == 'posttreatment_asse_arm_2', c('screen_id', 'redcap_event_name', 'hamd_depressed_mood', 'hamd_guilt', 'hamd_activities', 'hamd_retardation', 'hamd_anxiety_psychic', 'hamd_somsxs_general')]
    ...
    eclin <- edat[edat$redcap_event_name == 'baseline_arm_2' | edat$redcap_event_name == 'posttreatment_asse_arm_2', c('screen_id', 'redcap_event_name', grep(outcome, names(edat), value = T))]
  }
  ...
  tdem <- tdat[tdat$redcap_event_name=='register_arm_2', c('screen_id', 'cont_age', 'cont_sex')]
  tdem_dep_features <- tdat[tdat$redcap_event_name=='consult_arm_2', c('screen_id', 'dabst_duration', 'dabst_num_episodes')]
  tdem <- merge(tdem, tdem_dep_features, by = 'screen_id')
  
  if(outcome=='hdrs6'){
    tmp <- tdat[tdat$redcap_event_name == 'pretsd_assessment_arm_2' | tdat$redcap_event_name == 'posttsd_assessment_arm_2', c('screen_id', 'redcap_event_name', 'hamd_depressed_mood', 'hamd_guilt', 'hamd_activities', 'hamd_retardation', 'hamd_anxiety_psychic', 'hamd_somsxs_general')]
    ...
    tclin <- tdat[tdat$redcap_event_name == 'pretsd_assessment_arm_2' | tdat$redcap_event_name == 'posttsd_assessment_arm_2', c('screen_id', 'redcap_event_name', grep(outcome, names(tdat), value = T))]
  }
  ...
  merged_clinical_data$time_point[grep('post', merged_clinical_data$redcap_event_name)] <- 'Follow-up'
